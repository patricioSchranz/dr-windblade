...
<section class="e-medication">
    ...
    <div class="e-medication_left-side">
        <picture class="animation-element animation--style_clippy-from-left-to-right animation--duration_500">
            <source srcset="./../graphics/pics/pharmacy-wmc-750.webp" media="(max-width: 750px)">
            <source srcset="./../graphics/pics/pharmacy-wmc-1500.webp" media="(max-width: 1500px)">
            <source srcset="./../graphics/pics/pharmacy.webp" media="(min-width: 1500px)">
            <img src="./../graphics/pics/pharmacy.webp" alt="pharmacy" loading="lazy">
        </picture>
    </div>
    ...
    <div class="e-medication_right-side">
        ...
        <div class="container-user-data animation-element animation--style_fade-up animation--duration_100 animation--delay_1300 animation--trigger-point_100">
            <p class="text-hint">
