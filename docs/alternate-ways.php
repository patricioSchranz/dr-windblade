    ...
    <section class="alternate-ways_tcm" id="tcm">
        ...
        <article class="alternate-ways_tcm_topic" id="moxibustion">
            ...
            <header>
                ...
                <img src="../graphics/pics/moxibustion.jpg" alt="moxibustion">
            </header>
           ...
           <a href="./alternate-services.php#tuina">Zu meinem Moxibustion Angebot</a>
        </article>
        ...
        <article class="alternate-ways_tcm_topic" id="nutritional-advice">
            ...
            <header>
                ...
                <img src="../graphics/pics/nutritional.jpg" alt="nutritional">
            </header>
           ...
           <a href="./alternate-services.php#nutritional-advice">Zu meinem Ernährungsberatungs Angebot</a>
        </article>
        ...
        <article class="alternate-ways_tcm_topic" id="qi-gong">
            ...
            <header>
                ...
                <img src="../graphics/pics/qi-gong.jpg" alt="qi gong">
            </header>
